...
public class testFunny {
    ...
    public static void createAsciiPic(final String path) throws Exception {
        ...
        try {
            ...
            image = zoomImage(image, image.getWidth() / 10, image.getHeight() / 10);
...
//                    System.out.print(str);
     ...
     */
    public static BufferedImage zoomImage(BufferedImage image, int w, int h) throws Exception {
        ...
        wr = w * 10.0 / bufImg.getWidth();     //获取缩放比例
        hr = h * 9.0 / bufImg.getHeight();
    ...
    public static void main(final String[] args) {
        try {
            testFunny.createAsciiPic("http://www.uuabb.cn:81/5129f70a-1ef4-495f-8559-477a829ad8cd.png");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
